...
class EmployeeMetaboxModel
{
    ...
    {
        add_action('admin_init', [$this, 'company_employee_meta_boxes']);
        add_action('save_post', [$this, 'company_employee_save_meta_boxes_post']);
    }
    ...
    public function company_employee_meta_boxes()
    {
        add_meta_box(
            ...
            [$this, 'company_employee_meta_boxes_post'],        // callback function to render the field
            [$this, 'company_employee'],                       // name of the post type which to render field
