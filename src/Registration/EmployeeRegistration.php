...
class EmployeeRegistration
{
    ...
    public function employeeRegistrationInit()
    {
        ...
        wp_register_script('employee_block_script', plugins_url( 'build/EmployeeBlock.js', dirname(__DIR__)), array('wp-blocks','wp-editor'));
        ...
        wp_register_script('employee_public_script', plugins_url( 'build/EmployeePublic.js', dirname(__DIR__)), array('wp-blocks','wp-editor'));
